...
<body>
    <div class="contenedor">
        ...
        <div class="mitad2">
            ...
            <div class="contentpage" id="contentList">
                <div class="addntitle">
                    <h4 class="titulolist">
                        ...
                        Listado de Tratamientos <img src="<?php echo URL;?>public_html/iconos/flechaderecha.png" alt="x"/>
                        <button class="addbtn" type="button" id="btnAgregar"><span class="addtxt">Nuevo Tratamiento</span></button>
                    </h4>
                    <hr>
                </div>
                <div class="searchbox">
            ...
            <div id="contentForm" class="contact-form mt-3 d-none">
                <span class="agregartxt">Tratamiento</span>
                <form id="FormTratamiento" enctype="multipart/form-data">
                    <input type="hidden" name="id_tratamiento" id="id_tratamiento" value="0">

                    <label for="nombre_tratamiento">Nombre Tratamiento:</label>
                    <input type="text" id="nombre_tratamiento" name="nombre_tratamiento" required>

                    <label for="descripcion_tratamiento">Descripción:</label>
    ...
    <script src="<?php echo URL;?>public_html/customjs/tratamientos.js"></script>
</body>
</html>
