...
<body>
    <div class="contenedor">
        ...
        <div class="mitad2">
            ...
            <div class="contact-form mt-3">
                <div>
                    <label for="autoSizingInput">ID de la Cuota:</label>
                    <div class="selectform">
                        <select name="id_detalleplanpago" id="id_detalleplanpago" class="form-select">

                        </select>
                    </div>

                    <label for="autoSizingInput">Plan de Pago del paciente:</label>
                    <div class="selectform">
                        <select name="id_planpago" id="id_planpago" class="form-select">
    ...
    <script src="<?php echo URL;?>public_html/customjs/reportecuotas.js"></script>
</body>
</html>