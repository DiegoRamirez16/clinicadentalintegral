...
<head>
    ...
    <title>Reportes Expediente</title>
</head>
<body>
        ...
        <div class="mitad2">
            ...
            <div class="contact-form mt-3">
                <div>
                    ...
                    <label for="autoSizingInput">Nombre Paciente:</label>
    ...
    <script src="<?php echo URL;?>public_html/customjs/reporteexpedientes.js"></script>
</body>
</html>