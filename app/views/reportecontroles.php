...
<head>
    ...
    <title>Reportes Controles Clinicos</title>
</head>
<body>
    <div class="contenedor">
        ...
        <div class="mitad2">
            ...
            <div class="contact-form mt-3">
                <div>
                    <label for="autoSizingInput">Pacientes:</label>
                    ...
                    <div class="selectform d-none">
                        <select name="id_controles" id="id_controles" class="form-select">
    ...
    <script src="<?php echo URL;?>public_html/customjs/reportecontroles.js"></script>
</body>
</html>